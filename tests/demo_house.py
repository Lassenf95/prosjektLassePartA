...
motion_sensor = Sensor(id="cd5be4e8-0e6b-4cb5-a21f-819d06cf5fc5", supplier="NebulaGuard Innovations", model_name="MoveZ Detect 69", device_name='bevegelses-sensor', sensor_unit= 'movement')
